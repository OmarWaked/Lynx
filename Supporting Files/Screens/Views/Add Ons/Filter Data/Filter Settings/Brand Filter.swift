...
class BrandFilter: UIViewController,UITableViewDelegate, UITableViewDataSource{
//    
...
//        
//        if viewLabel == "Search" {
//            searchBrandArray.removeDuplicates()
//            self.brands = searchBrandArray
//        }else{
//            couponBrandArray.removeDuplicates()
//            self.brands = couponBrandArray
//        }
//        
//        for brand in self.brands {
//            let brandKey = String(brand.prefix(1))
//            if var brandValues = self.brandDictionary[brandKey] {
//                brandValues.append(brand)
//                self.brandDictionary[brandKey] = brandValues
//            } else {
//                self.brandDictionary[brandKey] = [brand]
//            }
//        }
//        
//        self.brandSectionTitles = [String](brandDictionary.keys)
//        self.brandSectionTitles = brandSectionTitles.sorted(by: { $0 < $1 })
//        
//    }
//    
...
//            navigationItem.title = "Filter Brands"
...
//            tableview.register(UITableViewCell.self, forCellReuseIdentifier: "brandFilter")
//            tableview.dataSource = self
//            tableview.delegate = self
//            tableview.isScrollEnabled = true
//            tableview.separatorInset = UIEdgeInsets(top: 0, left: 15, bottom: 0, right: 25)
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "brandFilter", for: indexPath)
...
//        if let brandValues = brandDictionary[brandKey] {
//            cell.textLabel?.text = brandValues[indexPath.row]
//        }
//        return cell
//    }
//
...
//        selectedFilterBrandArray.append((cell?.textLabel?.text)!)
...
//        let cell = tableView.cellForRow(at: indexPath)
//        selectedFilterBrandArray.remove(at: indexPath.row)
//        UIView.animate(withDuration: 0.5) {
...
//    
//    @objc func apply(){
//        selectedFilterBrandArray.removeDuplicates()
//        if viewLabel == "Search" {
...
//        NotificationCenter.default.post(name: NSNotification.Name("closeBrandFilter"), object: nil)
//    }
